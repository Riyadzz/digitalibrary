    ...
    <div class="container text-center">
        <div class="content mt-3">
            <div class="card bg-success bg-gradient">
                <div class="card-body">
                    <a href="http://localhost/digitalibrary/admin/" class="btn text-light">HOME</a>
                    <a href="http://localhost/digitalibrary/admin/kategoribuku.php" class="btn text-light">KATEGORI BUKU</a>
                    <a href="http://localhost/digitalibrary/admin/tampil_buku.php" class="btn text-light">BUKU</a>
                    <a href="http://localhost/digitalibrary/admin/user/tampil_user.php" class="btn text-light">USERS</a>
                    <a href="http://localhost/digitalibrary/peminjam/form_peminjaman.php/" class="btn text-light">PEMINJAMAN</a>
                    <a href="http://localhost/digitalibrary/peminjam/laporanpeminjam.php" class="btn text-light">LAPORAN PEMINJAMAN</a>
        ...
        <div class="container">
            ...
            <button class="menu-btn" onclick="window.location.href='http://localhost/digitalibrary/admin/index.php'">Kembali ke Menu</button>
        </div>
    </div>
</body>
</html>
